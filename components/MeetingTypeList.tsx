  ...
  const createMeeting = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: `Meeting failed due to ${error}`,
      });
    } finally {
      setLoading(false);
    }
  ...
  return (
    <section className="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4">
      ...
      <HomeCard
        ...
        title="Join Meeting"
        description="Join an meeting via link"
      ...
      >
        <Input 
          ...
          className="rounded-xl border-none bg-dark-3 focus-visible:ring-0 focus-visible:ring-offset-0"
